...
import 'package:k_tic_tac_toe/game_ui/components/game_elements.dart';
import 'package:k_tic_tac_toe/gradient/constants.dart';
import 'package:k_tic_tac_toe/gradient/particle.dart';
import 'package:k_tic_tac_toe/utils/extensions.dart';
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, snapshot) {
        particles.forEach((e) => e.updateVelocities(MediaQuery.of(context).size.offset));
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  stops: [0.0 + _gradientMovementAnim.value, 1.0 - _gradientMovementAnim.value],
                  begin: begin,
                  end: end,
                ),
              ),
